package com.yuxiang.guli.common.base.result;
...
public enum ResultCodeEnum {
    ...
    UNIQUE_NAME(false, 20002, "讲师名字重名"),
    ...
    FETCH_USERINFO_ERROR(false, 23003, "获取用户信息失败"),
    FETCH_ACCESSTOKEN_FAILD(false, 23004, "获取accessToken失败"),
