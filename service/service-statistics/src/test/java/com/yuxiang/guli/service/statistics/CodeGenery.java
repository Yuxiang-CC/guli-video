...
public class CodeGenery {
    ...
    public void genCode() {
        ...
        String projectPath = System.getProperty("user.dir"); // 获取当前项目的路径D:\IDEA程序\guli-video-parent\service\service-edu
        ...
        pc.setParent("com.yuxiang.guli.service");
...
//
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.yuxiang.guli.service.base.model.BaseEntity");
        // 填写BaseEntity中的公共字段
